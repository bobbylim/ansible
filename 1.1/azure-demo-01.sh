...
ansible-playbook -i ~/github/ansible/1.1/inventory/hosts ~/github/ansible/1.1/playbook/azure/pb-azure-vn.yaml
cat ~/github/ansible/1.1/command/azure-demo-01.txt | parallel "{}"
